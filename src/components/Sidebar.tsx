    ...
    <>
      ...
      <aside
        className={`${
          isMobile
            ...
            : `sticky top-20 flex min-w-[260px] flex-col rounded-lg border bg-card shadow-sm ${
      ...
      >
        ...
        <div className="flex flex-1 flex-col overflow-hidden">
          <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as 'joz' | 'surah')} className="flex h-full flex-col">
            ...
            {/* Surah Tab Content */}
            <TabsContent value="surah" className="flex-1 overflow-hidden data-[state=active]:flex data-[state=active]:flex-col">
              {/* Search Input */}
              <div className="border-b p-3">
                <div className="relative">
                  ...
                  <Input
                    ...
                    className={`h-9 ${isRTL ? 'pr-9 pl-3' : 'pl-9 pr-3'}`}
                    dir={isRTL ? 'rtl' : 'ltr'}
                  />
                </div>
              </div>
                        ...
                        return (
                          <li key={surah.id}>
                            <button
                              ...
                              className={`
                                w-full rounded-md px-3 py-2.5 text-left text-sm font-medium transition-all
